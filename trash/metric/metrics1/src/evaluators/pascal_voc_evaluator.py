...
def plot_precision_recall_curve(results,
    ...
    for classId, result in results.items():
        print('classId =', classId) # classId = U
                                    # classId = P
                                    # classId = D
        if result is None:
        ...
        # print('method =', method)
        print('presicion_{} ='.format(classId),         precision)
        print('recall_{}    ='.format(classId),         recall)
        print('average_presicion_{} ='.format(classId), average_precision)
        
        # saving as a txt file.
        # with opeb('precision')
        # with open('centernet_presicion_{}.txt'.format(classId), 'w') as f:
        #     for num in precision:
        #         f.write(str(num) + ' ')
        # with open('centernet_recall_{}.txt'.format(classId), 'w') as f:
        #     for num in recall:
        #         f.write(str(num) + ' ')
        # with open('D:\Github\Python\object_detection_metrics_new\txt_saving\presicion_{}.txt'.format(classId), 'w') as f:
        #     for num in precision:
        #         f.write(str(num) + ' ')
        with open(f'precision_{classId}.txt', 'w') as f:
            for num in precision:
                f.write(f'{num} ')
        with open(f'recall_{classId}.txt', 'w') as f:
            for num in recall:
                f.write(f'{num} ')
