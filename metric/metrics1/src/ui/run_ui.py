    ...
    def btn_run_clicked(self):
        ...
        if self.chb_metric_AP_pascal.isChecked() or self.chb_metric_mAP_pascal.isChecked():
            ...
            pascal_res = get_pascalvoc_metrics(gt_annotations,
                                               ...
                                               generate_table=True)
            # print('pascal_res U[precision] =', pascal_res['per_class']['U']['precision'])
            # print('pascal_res D[precision] =', pascal_res['per_class']['D']['precision'])
            # print('pascal_res P[precision] =', pascal_res['per_class']['P']['precision'])
            
            # with open(r'D:\Github\DUP\yolov7\final_training_230427\metric_output_test\U_precision.csv', 'w', newline="") as fp:
            #     writer = csv.DictWriter(fp, fieldnames=pascal_res['per_class']['U']['precision'].keys())
            #     writer.writeheader()
            #     writer.writerow(pascal_res['per_class']['U']['precision'])
                
            # with open(r'D:\Github\DUP\yolov7\final_training_230427\metric_output_test\output_pickle.pkl', 'wb') as fp:
            #     pickle.dump(pascal_res['per_class'], fp)
            #     print('dictionary saved!')
                
            # with open(r'D:\Github\DUP\yolov7\final_training_230427\metric_output_test\output_json.json', 'w') as fp:
            #     json.dump(pascal_res, fp)
...
# with open(r'D:\Github\DUP\yolov7\final_training_230427\metric_output_test\output_pickle.pkl', 'rb') as fp:
