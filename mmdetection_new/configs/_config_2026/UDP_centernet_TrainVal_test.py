# =========================================================
# CONFIG: configs/my_centernet_r18_trainval_final.py
# Description: Final Run (Batch Size 16, 50 Epochs, TrainVal -> Test)
# =========================================================
...
val_dataloader = dict(
    _delete_=True,
    # CHANGED: Increased from 8 to 16 (Faster validation)
    batch_size=16,
    num_workers=8,
    persistent_workers=True,
    drop_last=False,
...
optim_wrapper = dict(
    type='OptimWrapper',
    # CHANGED: Increased LR from 0.0025 to 0.0050 because we doubled batch size
...
# 7. RUNTIME
work_dir = '/mnt/Documents/Dad/github/DUP/mmdetection_new/work_dirs/centernet_r18_trainval_final'
