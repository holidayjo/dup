...
load_from = 'work_dirs/faster_rcnn_r50_TrainVal_5_times/seed0/epoch_11.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    classwise=True,
    metric='bbox',
    outfile_prefix='work_dirs/pr_curve_data_temp/Faster_R-CNN_seed0',
    type='CocoMetric')
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(keep_ratio=True, scale=(
...
work_dir = 'work_dirs/faster_rcnn_r50_TrainVal_5_times/seed0_eval'
