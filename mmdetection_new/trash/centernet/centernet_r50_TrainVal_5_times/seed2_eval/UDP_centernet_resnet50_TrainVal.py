...
load_from = 'work_dirs/centernet_r50_TrainVal_5_times/seed2/epoch_34.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    format_only=False,
    metric='bbox',
    outfile_prefix='work_dirs/pr_curve_data/CenterNet_seed2',
    type='CocoMetric')
test_pipeline = [
    dict(to_float32=True, type='LoadImageFromFile'),
    dict(keep_ratio=True, scale=(
...
work_dir = 'work_dirs/centernet_r50_TrainVal_5_times/seed2_eval'
