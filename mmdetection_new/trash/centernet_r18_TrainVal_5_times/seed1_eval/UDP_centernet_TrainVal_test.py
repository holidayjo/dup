...
load_from = 'work_dirs/centernet_r18_TrainVal_5_times/seed1/epoch_50.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ...
    format_only=False,
    metric='bbox',
    outfile_prefix='work_dirs/pr_curve_data/CenterNet_seed1',
    type='CocoMetric')
test_pipeline = [
    dict(backend_args=None, to_float32=True, type='LoadImageFromFile'),
    dict(
...
work_dir = 'work_dirs/centernet_r18_TrainVal_5_times/seed1_eval'
