...
data_root    = '/content/data_mmdet/one_image/'  # The location of dataset.
...
val_dataloader = dict(
    ...
    dataset            = dict(type         = dataset_type,
                              data_root    = data_root,
                              ann_file     = '/content/data_mmdet/one_image/val/val.json',
...
model = dict(
    ...
    rpn_head=dict(
        ...
        anchor_generator=dict(
            ...
            scales=[8],                # if the models cannot detect small objects, set as 4.
            ratios=[0.5, 1.0, 2.0],
...
log_level = 'INFO'
load_from = '/content/drive/MyDrive/IEEE_Access/code/weights/faster_rcnn_r50_fpn_1x_coco_20200130-047c8118.pth' # None
resume    = False
